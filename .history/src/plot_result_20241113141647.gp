...
set output "../visuals/non_blocking_hist.png"

# Set titles and labels
set title "Computation vs Communication Time using Non-Blocking for Different Process Counts (Matrix size 12,000)"
...
plot "../data/timing_hybrid_results.csv" using 2:xtic(1) title "Computation Time (ms)", \
     "../data/timing_hybrid_results.csv" using 3 title "Communication Time (ms)"
