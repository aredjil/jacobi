...
set output "../visuals/comm_vs_comp_hist.png"
...
plot "../data/timing_results.csv" using 2:xtic(1) title "Computation Time (ms)", \
     "../data/timing_results.csv" using 3 title "Communication Time (ms)"
