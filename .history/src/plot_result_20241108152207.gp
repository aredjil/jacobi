...
plot "../data/timing_non_blocking_results.csv" using 3:xtic(1) title "Computation Time (ms)", \
     "../data/timing_non_blocking_results.csv" using 2 title "Communication Time (ms)"
