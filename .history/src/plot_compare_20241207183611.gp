...
plot 'data_mpi.csv' using ($0*2-0.3):3 title "MPI Computation Time" lc rgb "blue", \
     '' using ($0*2-0.3):2 title "MPI Communication Time" lc rgb "red", \
     'data_openacc.csv' using ($0*2+0.3):3 title "OpenACC Computation Time" lc rgb "green", \
     '' using ($0*2+0.3):2 title "OpenACC Communication Time" lc rgb "orange"
