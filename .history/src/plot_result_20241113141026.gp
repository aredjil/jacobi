...
set title "Computation Time USING Non-Blocking for Different Process Counts (Matrix size 12,000)"
...
plot "../data/timing_blocking_results.csv" using 2:xtic(1) title "Computation Time (ms)", \
