...
set title "Communication vs Computation Times, for a non-blocking openacc jacosolver of 12K mesh size for 10 iterations"
...
plot 'data_openacc.csv' using 3:xtic(1) title "Computation Time" lc rgb "blue", \
