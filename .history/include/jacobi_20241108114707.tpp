 ...
 */
template <typename T>
void Solver<T>::jacobi(const size_t &max_steps, const size_t &print_interval)
{
    size_t n = m.size;
    size_t counter = 1;
 ...
 */
template <typename T>
void Solver<T>::jacobi_parallel(const size_t &max_steps, const size_t &print_interval)
{
    size_t n = m.size;
    size_t counter = 1;
    /**
