...
set output "../visuals/comm_vs_comp_non_blocking_hist.png"
...
plot "../data/timing_non_blocking_results.csv" using 3:xtic(1) title "Communication Time (ms)", \
     "../data/timing_non_blocking_results.csv" using 2 title "Computation Time (ms)"
